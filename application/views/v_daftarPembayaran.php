...
<head>
    <title>Daftar Pembayaran | Asy-Syifa CARE </title>
    <?php
                ...
                <div class="col-12">
                    <div class="cart-table clearfix" >
                        <table align="center" class="table table-responsive" style="color:black;">
                            ...
                            <tbody id="pagin">
                                <?php foreach($daftarG as $payment){ 

                                if ($payment->status_pembayaran == "Sudah dibayar" || $payment->status_pembayaran == "Sudah dikonfirmasi"){
                                        $style = "style='color:green;'"; 
                                    }else{
                                        if ($payment->status_pembayaran == "Belum dibayar"||$payment->status_pembayaran == "Bukti Transfer Salah"){
                                ...
                                <tr>
                                    ...
                                    <td class="total_price">
                                        <span <?php echo $style; ?>><?php echo $payment->status_pembayaran; ?></span>
                                    </td>
                                    <td class="total_price">
                                        <span style='color:black;'><?php echo $payment->status_penerimaan_barang; ?></span>
                                    </td>
                                     <td class="total_price">
