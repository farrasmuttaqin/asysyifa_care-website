                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Tabel Users</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Data Registered Users</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="data-tables">
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach($users as $best){
                                            ?>
                                                <tr>
                                                    <td><?php echo $best->id_user; ?></td>
                                                    <td><?php echo $best->nama_lengkap; ?></td>
                                                    <td><?php echo $best->email; ?></td>
                                                    <td><?php echo $best->active; ?></td>
                                                    <td><?php echo $best->nomor_hp; ?></td>
                                                    <td><?php echo $best->awal_join; ?></td>
                                                 </tr>
                                            <?php
                                            }
                                            ?>
