                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Product Cosmetic & Home Care</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="shop-sorting-data d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div class="shop-page-count">
                            ...
                            ?>
                            <p>Showing <?php echo $cntCHC; ?> Results</p>
                        </div>
                        <!-- Search by Terms -->
                        <div class="search_by_terms">
                            <form action="<?php echo base_url(); ?>product/sortCHC/" method="GET" class="form-inline">
