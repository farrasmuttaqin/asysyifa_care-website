                    ...
                    <div class="shop-sidebar-area">
                        ...
                        <div class="shop-widget catagory mb-50">
                            ...
                            <div class="widget-desc">
                                <a href="<?php echo base_url(); ?>search/allProduct/">
                                    <div class="custom-control d-flex align-items-center mb-2">
                                        <?php echo $jeniss; ?> in All Products &nbsp <span class="text-muted"> (<?php echo $cntSearch; ?>)</span>
                                    </div>
                                </a>
                                <!-- Single Checkbox -->
                                <a href="<?php echo base_url(); ?>search/searchCosmetic/">
                                    <div class="custom-control d-flex align-items-center mb-2">
                                        <?php echo $jeniss; ?> in Cosmetic & Home Care &nbsp <span class="text-muted"> (<?php echo $cntCHC; ?>)</span>
                                    </div>
                                </a>
                                <!-- Single Checkbox -->
                                <a href="<?php echo base_url(); ?>search/searchConsumtion/">
                                    <div class="custom-control d-flex align-items-center mb-2">
                                        <?php echo $jeniss; ?> in Healthy Food & Beverage &nbsp <span class="text-muted"> (<?php echo $cntHFB; ?>)</span>
                                    </div>
                                </a>
                                <!-- Single Checkbox -->
                                <a href="<?php echo base_url(); ?>search/searchHerbs/">
                                    <div class="custom-control d-flex align-items-center mb-2">
                                        <?php echo $jeniss; ?> in Herbs &nbsp <span class="text-muted"> (<?php echo $cntHerbs; ?>)</span>
                                    </div>
                                </a>
                            </div>
                        </div>
