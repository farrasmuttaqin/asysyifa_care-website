...
<head>
    <title>Detail Article | Asy-Syifa CARE</title>
    <?php
                        ...
                        <div class="single-widget-area">
                            ...
                            <div class="single-latest-post d-flex align-items-center">
                                ...
                                <div class="post-content">
                                    <a href="<?php echo base_url('article/detailArticle/'.$post->id_paper.'/'); ?>" class="post-title">
                                        <h6><?php echo $post->judul; ?></h6>
                                    </a>
                                    <a href="<?php echo base_url('article/detailArticle/'.$post->id_paper.'/'); ?>" class="post-date"><?php echo $post->tanggal_publish; ?></a>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
